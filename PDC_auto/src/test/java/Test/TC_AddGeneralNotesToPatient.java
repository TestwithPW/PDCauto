...
public class TC_AddGeneralNotesToPatient  extends Baseclass {
	...
	@Test(priority=4)
	public void addGeneralNotes() throws InterruptedException, IOException, AWTException {
		AddingNotesToPatientPage notes = new AddingNotesToPatientPage(driver);
		notes.addNewGeneralNote();
		Thread.sleep(1000);
		Screenshot ss = new Screenshot();
		Thread.sleep(3000);
		ss.captureScreenshot(driver, null);
